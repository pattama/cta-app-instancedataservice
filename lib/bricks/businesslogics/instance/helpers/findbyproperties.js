 ...
 */
class FindByProperties extends BaseHelper {
...
//    const instance = context.data;
    return new Promise((resolve, reject) => {
      const pattern = {
        type: 'object',
//        items: Instance.keys(),
        items: Instance.findpropertieskeys(),
      };
      pattern.items.id.optional = true;
      const validation = validate(context.data.payload.rest.body.query, pattern);
...
module.exports = FindByProperties;
