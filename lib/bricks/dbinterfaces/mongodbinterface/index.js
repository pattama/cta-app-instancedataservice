...
const GetTemplatesCountHelper = require('./helpers/gettemplatescount');
const GetTemplatesIndexHelper = require('./helpers/gettemplatesindex');
...
class MongoDBInterface extends BaseDBInterface {
  constructor(cementHelper, configuration) {
    ...
    this.helpers.set('getTemplatesCount',
      new GetTemplatesCountHelper(this.cementHelper, this.logger));
    this.helpers.set('getTemplatesIndex',
      new GetTemplatesIndexHelper(this.cementHelper, this.logger));
  }
}
