...
const datamodels = {
  instance: require(root + '/lib/utils/datamodels/instance.js'),
};
const schemas = {
...
class Create extends BaseDBInterfaceHelper {
  ...
  _validate(context) { // eslint-disable-line no-unused-vars
    context.data.payload.content = new datamodels[context.data.payload.type](context.data.payload.content);
